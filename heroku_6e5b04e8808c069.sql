<!DOCTYPE HTML><html lang='en' dir='ltr'><head><meta charset="utf-8" /><meta name="referrer" content="no-referrer" /><meta name="robots" content="noindex,nofollow" /><meta http-equiv="X-UA-Compatible" content="IE=Edge" /><style id="cfs-style">html{display: none;}</style><link rel="icon" href="favicon.ico" type="image/x-icon" /><link rel="shortcut icon" href="favicon.ico" type="image/x-icon" /><link rel="stylesheet" type="text/css" href="./themes/pmahomme/jquery/jquery-ui.css" /><link rel="stylesheet" type="text/css" href="js/codemirror/lib/codemirror.css?v=4.7.1" /><link rel="stylesheet" type="text/css" href="js/codemirror/addon/hint/show-hint.css?v=4.7.1" /><link rel="stylesheet" type="text/css" href="js/codemirror/addon/lint/lint.css?v=4.7.1" /><link rel="stylesheet" type="text/css" href="phpmyadmin.css.php?nocache=6096638780ltr" /><link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=4.7.1" media="print" id="printcss"/><title>phpmyadmin.co / us-cdbr-east-02.cleardb.com / heroku_6e5b04e8808c069 | phpMyAdmin 4.7.1</title><script data-cfasync="false" type="text/javascript" src="js/get_scripts.js.php?scripts%5B%5D=jquery/jquery.min.js&amp;scripts%5B%5D=jquery/jquery-migrate-3.0.0.js&amp;scripts%5B%5D=sprintf.js&amp;scripts%5B%5D=ajax.js&amp;scripts%5B%5D=keyhandler.js&amp;scripts%5B%5D=jquery/jquery-ui.min.js&amp;scripts%5B%5D=jquery/jquery.cookie.js&amp;scripts%5B%5D=jquery/jquery.mousewheel.js&amp;scripts%5B%5D=jquery/jquery.event.drag-2.2.js&amp;scripts%5B%5D=jquery/jquery-ui-timepicker-addon.js&amp;v=4.7.1"></script><script data-cfasync="false" type="text/javascript" src="js/get_scripts.js.php?scripts%5B%5D=jquery/jquery.ba-hashchange-1.3.js&amp;scripts%5B%5D=jquery/jquery.debounce-1.0.5.js&amp;scripts%5B%5D=menu-resizer.js&amp;scripts%5B%5D=cross_framing_protection.js&amp;scripts%5B%5D=rte.js&amp;scripts%5B%5D=tracekit/tracekit.js&amp;scripts%5B%5D=error_report.js&amp;scripts%5B%5D=config.js&amp;scripts%5B%5D=doclinks.js&amp;scripts%5B%5D=functions.js&amp;v=4.7.1"></script><script data-cfasync="false" type="text/javascript" src="js/get_scripts.js.php?scripts%5B%5D=navigation.js&amp;scripts%5B%5D=indexes.js&amp;scripts%5B%5D=common.js&amp;scripts%5B%5D=page_settings.js&amp;scripts%5B%5D=shortcuts_handler.js&amp;scripts%5B%5D=codemirror/lib/codemirror.js&amp;scripts%5B%5D=codemirror/mode/sql/sql.js&amp;scripts%5B%5D=codemirror/addon/runmode/runmode.js&amp;scripts%5B%5D=codemirror/addon/hint/show-hint.js&amp;scripts%5B%5D=codemirror/addon/hint/sql-hint.js&amp;v=4.7.1"></script><script data-cfasync="false" type="text/javascript" src="js/get_scripts.js.php?scripts%5B%5D=codemirror/addon/lint/lint.js&amp;scripts%5B%5D=codemirror/addon/lint/sql-lint.js&amp;scripts%5B%5D=console.js&amp;v=4.7.1"></script><script data-cfasync='false' type='text/javascript' src='js/whitelist.php?lang=en&amp;db=heroku_6e5b04e8808c069&v=4.7.1'></script><script data-cfasync='false' type='text/javascript' src='js/messages.php?lang=en&amp;db=heroku_6e5b04e8808c069&v=4.7.1'></script><script data-cfasync='false' type='text/javascript' src='js/get_image.js.php?theme=pmahomme&v=4.7.1'></script><script data-cfasync="false" type="text/javascript">// <![CDATA[
PMA_commonParams.setAll({common_query:"",opendb_url:"db_structure.php",collation_connection:"utf8mb4_unicode_ci",lang:"en",server:"1",table:"",db:"heroku_6e5b04e8808c069",token:"ae8f12bd95b6cfe53e10a7087828e363",text_dir:"ltr",show_databases_navigation_as_tree:"1",pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:"",LimitChars:"50",pftext:"P",confirm:"1",LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:"1",PMA_VERSION:"4.7.1",auth_type:"cookie",user:"ba63c4bb5372ec"});
ConsoleEnterExecutes=false
AJAX.scriptHandler.add("jquery/jquery.min.js",0).add("jquery/jquery-migrate-3.0.0.js",0).add("whitelist.php?lang=en&amp;db=heroku_6e5b04e8808c069",1).add("sprintf.js",1).add("ajax.js",0).add("keyhandler.js",1).add("jquery/jquery-ui.min.js",0).add("jquery/jquery.cookie.js",0).add("jquery/jquery.mousewheel.js",0).add("jquery/jquery.event.drag-2.2.js",0).add("jquery/jquery-ui-timepicker-addon.js",0).add("jquery/jquery.ba-hashchange-1.3.js",0).add("jquery/jquery.debounce-1.0.5.js",0).add("menu-resizer.js",1).add("cross_framing_protection.js",0).add("rte.js",1).add("tracekit/tracekit.js",1).add("error_report.js",1).add("messages.php?lang=en&amp;db=heroku_6e5b04e8808c069",0).add("get_image.js.php?theme=pmahomme",0).add("config.js",1).add("doclinks.js",1).add("functions.js",1).add("navigation.js",1).add("indexes.js",1).add("common.js",1).add("page_settings.js",1).add("shortcuts_handler.js",1).add("codemirror/lib/codemirror.js",0).add("codemirror/mode/sql/sql.js",0).add("codemirror/addon/runmode/runmode.js",0).add("codemirror/addon/hint/show-hint.js",0).add("codemirror/addon/hint/sql-hint.js",0).add("codemirror/addon/lint/lint.js",0).add("codemirror/addon/lint/sql-lint.js",0).add("console.js",1);
$(function() {AJAX.fireOnload("whitelist.php?lang=en&amp;db=heroku_6e5b04e8808c069");AJAX.fireOnload("sprintf.js");AJAX.fireOnload("keyhandler.js");AJAX.fireOnload("menu-resizer.js");AJAX.fireOnload("rte.js");AJAX.fireOnload("tracekit/tracekit.js");AJAX.fireOnload("error_report.js");AJAX.fireOnload("config.js");AJAX.fireOnload("doclinks.js");AJAX.fireOnload("functions.js");AJAX.fireOnload("navigation.js");AJAX.fireOnload("indexes.js");AJAX.fireOnload("common.js");AJAX.fireOnload("page_settings.js");AJAX.fireOnload("shortcuts_handler.js");AJAX.fireOnload("console.js");});
...
if (typeof configScriptLoaded !== "undefined" && configInlineParams) loadInlineConfig();
    ...
    <form action="prefs_manage.php" method="post" class="disableAjax">
        <input type="hidden" name="token" value="ae8f12bd95b6cfe53e10a7087828e363" />        <input type="hidden" name="json" value="" />
...
<div id="page_content"><div class="error"><h1>Error</h1><p><strong>SQL query:</strong>
<a href="db_sql.php?sql_query=SHOW+TABLE+STATUS+FROM+%60heroku_6e5b04e8808c069%60+WHERE+Name+%3D+%27cbs%27&amp;show_query=1&amp;db=heroku_6e5b04e8808c069"><span class="nowrap"><img src="themes/dot.gif" title="Edit" alt="Edit" class="icon ic_b_edit" />&nbsp;Edit</span></a>    </p>
<p>
<code class="sql"><pre>
SHOW TABLE STATUS FROM `heroku_6e5b04e8808c069` WHERE Name = 'cbs'
</pre></code>
</p>
<p>
    <strong>MySQL said: </strong><a href="./url.php?url=https%3A%2F%2Fdev.mysql.com%2Fdoc%2Frefman%2F5.5%2Fen%2Ferror-messages-server.html" target="mysql_doc"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help" /></a>
</p>
<code>#2006 - MySQL server has gone away</code><br/></div></div><div id="selflink" class="print_ignore"><a href="export.php?db=heroku_6e5b04e8808c069&amp;table=&amp;server=1&amp;target=" title="Open new phpMyAdmin window" target="_blank" rel="noopener noreferrer"><img src="themes/dot.gif" title="Open new phpMyAdmin window" alt="Open new phpMyAdmin window" class="icon ic_window-new" /></a></div><div class="clearfloat" id="pma_errors"><div class="error"><strong>Warning</strong> in ./libraries/dbi/DBIMysqli.php#184<br />
<img src="themes/dot.gif" title="" alt="" class="icon ic_s_error" /> mysqli_query(): MySQL server has gone away<br />
<br />
<strong>Backtrace</strong><br />
<br />
./libraries/dbi/DBIMysqli.php#184: mysqli_query(<br />
	<Class:mysqli>,<br />
	string 'SHOW PROCEDURE STATUS;',<br />
	integer 0,<br />
)<br />
./libraries/DatabaseInterface.php#267: PMA\libraries\dbi\DBIMysqli->realQuery(<br />
	string 'SHOW PROCEDURE STATUS;',<br />
	<Class:mysqli>,<br />
	integer 0,<br />
)<br />
./libraries/DatabaseInterface.php#1639: PMA\libraries\DatabaseInterface->tryQuery(<br />
	string 'SHOW PROCEDURE STATUS;',<br />
	<Class:mysqli>,<br />
	integer 0,<br />
	boolean false,<br />
)<br />
./libraries/DatabaseInterface.php#1743: PMA\libraries\DatabaseInterface->fetchResult(<br />
	string 'SHOW PROCEDURE STATUS;',<br />
	NULL,<br />
	NULL,<br />
	NULL,<br />
)<br />
./libraries/plugins/export/ExportSql.php#547: PMA\libraries\DatabaseInterface->getProceduresOrFunctions(<br />
	string 'heroku_6e5b04e8808c069',<br />
	string 'PROCEDURE',<br />
)<br />
./libraries/export.lib.php#617: PMA\libraries\plugins\export\ExportSql->exportRoutines(<br />
	string 'heroku_6e5b04e8808c069',<br />
	array,<br />
)<br />
./export.php#457: PMA_exportDatabase(<br />
	...
	string '
',<br />
	string 'db_export.php?db=heroku_6e5b04e8808c069',<br />
	string 'database',<br />
	boolean false,<br />
	boolean true,<br />
	boolean false,<br />
...
</div><div class="error"><strong>Warning</strong> in ./libraries/dbi/DBIMysqli.php#184<br />
<img src="themes/dot.gif" title="" alt="" class="icon ic_s_error" /> mysqli_query(): Error reading result set's header<br />
<br />
<strong>Backtrace</strong><br />
<br />
./libraries/dbi/DBIMysqli.php#184: mysqli_query(<br />
